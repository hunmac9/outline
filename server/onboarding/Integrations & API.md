...
\
Our integration code is also [open-source](https://github.com/hunmac9/outline) and we encourage third party developers and the community to build support for additional tools! 
